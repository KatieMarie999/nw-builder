...
//=============================================================================
// Olivia Engine - Meta Controls - for RPG Maker MV version 1.6.1 (Mod by DvLyon)
...
/*:
 * @plugindesc <MetaControls> for RPG Maker MV version 1.6.1. (Mod by DvLyon)
...
Game_Variables.prototype.value = function(variableId) {
	if (!!$dataSystem.variables[variableId] && 
		$dataSystem.variables[variableId].match(/<(?:Global|Global Meta)>/i)) {
		var value = ConfigManager.getMetaControlsData(0).variables[variableId] || 0
		this._data[variableId] = value
		return value
	} else if (!!$dataSystem.variables[variableId] && 
		$dataSystem.variables[variableId].match(/<(?:Local|Local Meta|Meta)>/i)) {
