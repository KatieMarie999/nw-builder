...
/*:
 * @plugindesc (v1.3) Displays multiple animated texts.
 * @author Moghunter
 *
 ...
 * PLUGIN COMMAND 
 * =============================================================================
 * To activate the text use the command below.
 *
 * infotext : ID : MODE : X : Y : FONTSIZE : DURATION : SPEED : COLOR : ALIGN : TEXT
 *
 * ID - It's the text ID
 * MODE - Type of animation.
 *     0 - Fade 
 *     1 - Zoom
 *     2 - Flip
 *     3 - Reverse
 ...
 *     8 - Swing
 *     9 - Random 
 * X - X-Axis Position of the Text.
 * Y - Y-Axis Position of the Text.
 * FONTSIZE - Font size.
 * DURATION - Animation duration.
 * SPEED - One letter activation speed among others.
 ...
 *
 * ----------------------------------------------------------------------------
 * To delete the text, use the command below.
 * 
 * clearinfotext : ID
 *
 * EG
