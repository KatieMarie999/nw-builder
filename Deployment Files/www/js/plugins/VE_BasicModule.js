...
(function () {
    ...
    DataManager.isDatabaseLoaded = function () {
        if (!VictorEngine.BasicModule.isDatabaseLoaded.call(this))
            return false;
    ...
    VictorEngine.loadNotetags = function () {
        if (VictorEngine.BasicModule.loaded)
            return;
    ...
    /**
     * @param {String} value1 The opening tag
     * @param {String} value2 The closing tag
     * @returns {RegExp} An expression designed to extract all notes.
     */
