 ...
 * IMAGES
 * =============================================================================
 * Record the indicator images in the folder /img/eventidicators/
 *
 * -----------------------------------------------------------------------------
 * ANIMATED (Frames)
 * -----------------------------------------------------------------------------
 * If the "Animated" function is activated, name the images as follows.
 *
 * FILENAME + _INDEX.png
 *
 * EG
 ...
 * COMMENT (EVENT)
 * =============================================================================
 * To activate the indicator put the comments below in the event.
 *
 * ------------------------------------------------------------------------------
 *
 * indicator : FILENAME : X : Y
 *
 * FILENAME - Definition of the file name.
 * X - X-Axis definition of the image.
 * Y - Y-Axis definition of the image.
 *
 * =============================================================================
 * EXTRA COMMENT (OPTIONAL)
 * =============================================================================
 *
 * TEXT - To add a text in the indicator put the comment below.
 *
 * text_indicator : TEXT
 *
 * ------------------------------------------------------------------------------
 * VARIABLE - To display a variable value use the comment below.
 *
 * variable_indicator : VARIABLE_ID
 *  
 * ------------------------------------------------------------------------------
 * RANGE VISIBILITY - To activate visibility by distance, place this
 * comment.
 *
 * range_indicator : RANGE
 *
 * ------------------------------------------------------------------------------
 * ANIMATED - To activate frame animation, enter this comment.
 *
 * animated_indicator : FRAMES : ANIMATION_SPEED
 *
 * ------------------------------------------------------------------------------
 * FONT_SIZE - To adjust the font size put the comment below.
 *
 * fontsize_indicator : X : Y
 *  
 * ------------------------------------------------------------------------------
 * BLEND MODE - To adjust the type of blend put the comment below.
 *
 * blendmode_indicator : BLEND_MODE
 *
 * ------------------------------------------------------------------------------
 * ROTATION - To activate the rotation animation put the comment below.
 *
 * rotation_indicator : ROTATION_SPEED
 * 
 * ------------------------------------------------------------------------------
 * SHAKE - To activate the shaking animation put the comment below.
 *
 ...
 *
 * ------------------------------------------------------------------------------
 * FLOAT - To activate the float animation, enter the comment below.
 *
 * float_indicator
 *
 * ------------------------------------------------------------------------------
 * SLIDE - To activate the slide animation, enter the comment below.
 *
 * slide_indicator
 *
 * ------------------------------------------------------------------------------
 * CLEAR - To delete the indicator use the comment below.
 *
 * clear_indicator
 *    
 * =============================================================================
 * PLUGIN COMMAND
 * =============================================================================
 * To show or hide the indicators use the commands below.
 *
 * show_indicator : EVENT_ID
 * hide_indicator : EVENT_ID
 *
 * To show or hide all the indicators use the command below.
 *
 * show_all_indicators
 * hide_all_indicators
 *
 * =============================================================================
 * To activate the indicator via Plugin Command use the commands below.
 *
 * ------------------------------------------------------------------------------
 *
...
Spriteset_Map.prototype.createEventIndicators = function () {
  ...
  for (var i = 0; i < this._characterSprites.length; i++) {
    if (typeof (this._characterSprites[i]._character._indData) != "undefined") {
